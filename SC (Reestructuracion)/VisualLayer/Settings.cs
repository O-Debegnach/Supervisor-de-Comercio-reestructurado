...
namespace VisualLayer.Properties {
    ...
    internal sealed partial class Settings {
        ...
        private void SettingChangingEventHandler(object sender, System.Configuration.SettingChangingEventArgs e) {
            ...
            if(e.SettingName == nameof(RutaBase))
            {
                FullBackupPath = e.NewValue + BackupPath;
                FullSavePath = e.NewValue + SavesPath;
                RegistroVentasCompleto = e.NewValue + RegistroVentasPath;
                ...
                if (!Directory.Exists(RegistroVentasCompleto))
                {
                    Directory.CreateDirectory(RegistroVentasCompleto);
                }
            }
        }
